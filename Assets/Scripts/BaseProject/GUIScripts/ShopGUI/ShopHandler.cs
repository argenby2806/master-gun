...
public class ShopHandler : MonoBehaviour
{
	...
	ObliusGameManager.GameState gameStateBeforeOpen;
	...
	void Update ()
	{
		...
		if (Input.GetMouseButton (0)) {
			...
			if (nearestItem == shopItems [0] || nearestItem == shopItems [shopItems.Count - 1]) {
				ScrollHandler.instance.scrollPower = 0;
			}
	...
	public void UnlockShopItem (ShopItem item)
	{
		...
		ScoreHandler.instance.specialPoints -= item.price;
	}
	...
	public void Activate ()
	{
		...
		gameStateBeforeOpen = ObliusGameManager.instance.gameState;
		ObliusGameManager.instance.gameState = ObliusGameManager.GameState.shop;
	...
	{
		ObliusGameManager.instance.gameState = gameStateBeforeOpen;
