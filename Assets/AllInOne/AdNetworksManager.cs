...
namespace Oblius.Assets.AllInOneAdnetworks
{
	public class AdNetworksManager : MonoBehaviour
	{
		...
		public int minSecondsBetweenInterstitial;
		...
		public void ShowInterstitial (Action onAdClosed)
		{
			...
			if (AdsEnabled && ((CurrentTime () - LastInterstitialShowTime) > minSecondsBetweenInterstitial)) {
				...
				#endif
					#if ALLINONE_UNITYADS
				case InterstitialAdNetworks.unityAds:
					unityAds.ShowInterstitial (onAdClosed);
					break;
					#endif
					#if ALLINONE_CHARTBOOST
		...
		public bool IsShowingInterstitial ()
		{
			...
			case InterstitialAdNetworks.admob:
				...
				#if ALLINONE_UNITYADS
			case InterstitialAdNetworks.unityAds:
				return unityAds.IsShowingInterstitial ();
				break;
				#endif
				#if ALLINONE_CHARTBOOST
			case InterstitialAdNetworks.chartboost:
		...
		public bool InterstitialLoaded ()
		{
			...
			case InterstitialAdNetworks.admob:
				...
				#if ALLINONE_UNITYADS
			case InterstitialAdNetworks.unityAds:
				return unityAds.InterstitialLoaded ();
				break;
				#endif
		...
		{
			DateTime epochStart = new DateTime (2017, 1, 1, 0, 0, 0, DateTimeKind.Utc);
